...
public class MimeUtilWrite483Test {

	@Test
	@Tag("valid")
	public void writeWithNoSpecialCharacters() {
	...
	@Test
	@Tag("valid")
	public void writeWithCarriageReturns() {
	...
	@Test
	@Tag("valid")
	public void writeWithSpecificOffsetAndLength() {
		byte[] input = "Hello World".getBytes();
		byte[] expected = "World".getBytes();
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		MimeUtil mimeUtil = new MimeUtil(baos, "\r\n".getBytes());
		try {
			mimeUtil.write(input, 6, 5);
			assertArrayEquals(expected, baos.toByteArray());
		}
		catch (IOException e) {
			fail("IOException should not have been thrown");
	...
	@Test
	@Tag("integration")
	public void writeIOExceptionHandling() {
		byte[] input = "Hello World".getBytes();
